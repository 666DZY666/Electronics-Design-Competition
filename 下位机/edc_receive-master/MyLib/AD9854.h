...
#define AD9854_UPDATE_LOCK PBout(5)
#define AD9854_CS PBout(6)
#define AD9854_RESET PBout(7)
...
#define AD9854_FWT_TEMP 1407374  // 2^48/20M 用来计算fwt 1407374.883 
...
void AD9854_SetSine(unsigned long int frequency,u16 shape); //设置正弦波幅度和频率
