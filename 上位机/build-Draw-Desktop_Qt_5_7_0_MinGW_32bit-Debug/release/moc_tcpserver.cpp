...
QT_MOC_LITERAL(4, 24, 15), // "onNewConnection"
QT_MOC_LITERAL(5, 40, 13) // "onRecvMessage"

    },
    "TCPServer\0newData\0\0data\0onNewConnection\0"
    "onRecvMessage"
};
...
void TCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TCPServer::newData)) {
                *result = 0;
                return;
            }
        }
